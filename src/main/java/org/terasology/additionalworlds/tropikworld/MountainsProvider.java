...
public class MountainsProvider implements ConfigurableFacetProvider {
    ...
    private TWMountainsConfiguration configuration = new TWMountainsConfiguration();
    ...
    {
        this.configuration = (TWMountainsConfiguration)configuration;
    }

    private static class TWMountainsConfiguration implements Component {
