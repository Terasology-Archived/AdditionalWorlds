...
public class SurfaceProvider implements FacetProviderPlugin {
    ...
    public void process(GeneratingRegion region) {
        ...
        Border3D border = region.getBorderForFacet(HeightFacet.class);
        HeightFacet facet = new HeightFacet(region.getRegion(), border);
        ...
        region.setRegionFacet(HeightFacet.class, facet);
    }
}
